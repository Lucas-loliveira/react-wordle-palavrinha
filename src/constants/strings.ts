export const GAME_TITLE = 'Palavrinha!'

export const WIN_MESSAGES = ['Boa Mozin!', 'Você é muito boa!', 'Parabéns Mozin!']
export const GAME_COPIED_MESSAGE = 'Compartilha mozin! '
export const NOT_ENOUGH_LETTERS_MESSAGE = 'Mo, tem que por mais letras'
export const WORD_NOT_FOUND_MESSAGE = 'Meu bem, essa palavrinha não existe, você está inventando'
...
export const CORRECT_WORD_MESSAGE = (solution: string) =>
  `A palavrinha era ${solution}`
export const WRONG_SPOT_MESSAGE = (guess: string, position: number) =>
  `Must use ${guess} in position ${position}`
export const NOT_CONTAINED_MESSAGE = (letter: string) =>
  `O chute precisa ter ${letter}`
